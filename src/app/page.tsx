    ...
    <main className="home-page">
      ...
      <section className="process shell new-how-it-works" id="how-it-works">
        ...
        <div className="process-flow">
          ...
          <article><div className="process-number">02</div><div className="process-icon"><Sparkles size={22} /></div><h3>Build your cash & bonus roadmap</h3><p>We map your reserve, bonus cash, direct-deposit capacity, and liquid remainder together so every recommendation fits the same plan.</p><span>Cash allocation · DD capacity · bonuses · HYSA remainder</span></article>
          <article><div className="process-number">03</div><div className="process-icon"><CalendarClock size={22} /></div><h3>Swap, add, and track your route</h3><p>Change any roadmap option, then confirm the real opening date when you actually use it. The remaining plan recalculates around your choices.</p><span>Your roadmap stays flexible as your money moves.</span></article>
