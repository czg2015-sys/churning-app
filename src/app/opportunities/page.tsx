  ...
  return (
    <main className="page-shell opportunity-library-page">
      <div className="shell">
        ...
        {!dataAvailable && <div className="disclaimer"><strong>The verified offer feed could not be loaded.</strong> Refresh to retry the live Supabase feed. Churning will not silently replace it with stale offer data.</div>}
